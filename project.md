...
- A fixed evaluation set of 25–40 questions drawn from real FBC chapters (e.g., Chapter 10 Means of Egress, Chapter 16 Structural Design — wind loads relevant to Naples' hurricane zone, Chapter 18 Soils and Foundations) and Naples-specific amendments (setbacks, flood elevation requirements, hurricane shutter code)
...
| M7 | 07 — When to use each | Decision engine: given query type (definitional lookup vs. numeric requirement vs. jurisdiction-specific amendment) and cost/latency constraints, recommend a model class + whether grounding is mandatory |
